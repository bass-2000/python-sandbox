...
parser = argparse.ArgumentParser(description='Game result')
parser.add_argument('--frames', type=str, default='', nargs='?', help='Значения фреймов')

args = parser.parse_args()

try:
    print('{} - {}'.format(args.frames, get_score(args.frames)))
